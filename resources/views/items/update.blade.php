...
<head>
    ...
    <title>Tel-U Loot - Update Item</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <style>
        .form-input {
            /* Consistent large styling: tall padding, readable text, full width (w-full) of its parent container */
            @apply w-full py-4 px-5 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition duration-150;
        }
    </style>
</head>
