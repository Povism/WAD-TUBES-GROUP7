...
<head>
    ...
    <title>Tel-U Loot - Update Forum Post</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <style>
        /* Focus color: RED */
        .form-input-forum {
            /* Text-center applied to input content */
            @apply w-full py-3 px-4 text-base border border-gray-300 rounded-lg 
                   focus:ring-2 focus:ring-red-700 focus:border-red-700 transition duration-150 text-center;
        }
        .form-textarea-forum {
            /* Text-center applied to textarea content */
            @apply w-full py-4 px-5 text-lg border border-gray-300 rounded-lg 
                   focus:ring-2 focus:ring-red-700 focus:border-red-700 transition duration-150 text-center;
        }
        /* Centering the block labels by making them full width and centered */
        .form-label-center {
            @apply block w-full text-center text-sm font-medium text-gray-700 mb-1;
        }
    </style>
</head>
