...
<head>
    ...
    <title>Tel-U Loot - Create Forum Post</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <style>
        /* Reverting focus color to RED for distinction */
        .form-input-forum {
            /* Full width is essential */
            @apply w-full py-3 px-4 text-base border border-gray-300 rounded-lg 
                   focus:ring-2 focus:ring-red-700 focus:border-red-700 transition duration-150;
        }
        .form-textarea-forum {
            /* Full width is essential */
            @apply w-full py-4 px-5 text-lg border border-gray-300 rounded-lg 
                   focus:ring-2 focus:ring-red-700 focus:border-red-700 transition duration-150;
        }
    </style>
</head>
        ...
        <div class="container mx-auto px-4 max-w-2xl"> 
            ...
            <form action="/forum" method="POST" class="space-y-6">
                <div class="bg-white p-6 rounded-xl shadow-md border-t-4 border-red-700 space-y-4">
                    ...
                    <div>
                        <label for="title" class="block text-sm font-medium text-gray-700 mb-1">Topic Title <span class="text-red-500">*</span></label>
                        <div class="-mx-4 md:mx-0"> 
                            <input type="text" id="title" name="title" placeholder="e.g., Best place to find used textbooks?" required class="form-input-forum">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md space-y-4">
                    ...
                    <div>
                        <label for="content" class="block text-sm font-medium text-gray-700 mb-1">Detailed Content <span class="text-red-500">*</span></label>
                        <div class="-mx-4 md:mx-0">
                            <textarea id="content" name="content" rows="12" placeholder="Write your post content here. Be detailed, clear, and respectful!" required class="form-textarea-forum"></textarea>
                        </div>
                    </div>
                </div>
